/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1882432fa07a6b0b88e39794a407412)
// Runtime types generated with workerd@1.20260623.1 2026-06-23 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_SECRET: string;
	OAUTH_CLIENT_ID: string;
	Doc2Image: DurableObjectNamespace<import("./worker/index").Doc2ImageContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Doc2ImageContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OAUTH_SECRET" | "OAUTH_CLIENT_ID">> {}
}
